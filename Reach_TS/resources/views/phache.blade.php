	...
	<div class="container" style="font-size: 16px;">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Nghiệp vụ bàn bar pha chế</li>
		  </ol>
		</nav>
		...
		<div class="row">
            <div class="col col-3">
                <ul style="display: block;" class="nav_top_loai_tin">NGÀNH HỌC
                    <li class="nav_loai_tin" style="border-left: 5px solid #fb9d0a; color: #fb9d0a;background: #fff;">Nghiệp vụ bàn bar pha chế</li>
            ...
            @if(isset($banbar))
            <div class="col col-9">
                @foreach($banbar as $ban)
                <img src="{{asset('upload/tintuc').'/'.$ban->tt_avatar}}" style="margin-top: -15px" alt="ảnh" title="Lập trình Web">
                <h1 class="loai_tin_top_content">{{$ban->tt_name}}</h1>
                <p>{{$ban->tt_title_seo}}</p>
                <p>{!! $ban->tt_content !!}</p>
                @endforeach
			</div>
            @endif
