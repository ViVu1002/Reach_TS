...
@section('content')
	...
	<div class="container" style="font-size: 18px">
		<div class="row">
			...
			@if(isset($bongda))
				<div>
					@foreach($bongda as $da)
					<img class="bong_da_reach" src="{{ asset('upload/tintuc').'/'.$da->tt_avatar }}">
					<h4 style="margin-top: 20px;">{{$da->tt_title_seo}} </h4>
					<a href="#" class="xem-them-top">Xem thêm ></a>
					@endforeach
				</div>
				<div class="row">
					<div class="col col-xl-6">
						@foreach($daihoc as $hoc)
						<div>
							<img src="{{ asset('upload/tintuc').'/'.$hoc->tt_avatar }}" class="doituonghocvien">
							<p>{{$hoc->tt_title_seo}} </p>
							<a href="#" class="xem-them-top">Xem thêm</a>
						</div>
						@endforeach
					</div>
					<div class="col col-xl-6" >
						@foreach($ngoaikhoa as $khoa)
						<div>
							<img src="{{ asset('upload/tintuc').'/'.$khoa->tt_avatar }}" class="doituonghocvien">
							<p>{{$khoa->tt_title_seo}} </p>
							<a href="#" class="xem-them-top">Xem thêm</a>
						</div>
						@endforeach
					</div>
			...
			<div class="col col-xl-4">
				<div class="article_top_nav">
					<ul>
						<li class="active breadcrumb-item-top" ><a href="#" class="breadcrumb-top">Đời sống học viên</a></li>
