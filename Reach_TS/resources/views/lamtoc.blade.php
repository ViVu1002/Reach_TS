	...
	<div class="container" style="font-size: 16px">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Lớp làm tóc</li>
		  </ol>
		</nav>
		...
		<div class="row">
            <div class="col col-3">
                <ul style="display: block;" class="nav_top_loai_tin">NGÀNH HỌC
                    <li class="nav_loai_tin" style="border-left: 5px solid #fb9d0a; color: #fb9d0a;background: #fff;">Lớp làm tóc</li>
            ...
            <div class="col col-9">
                @foreach($toc as $toc)
                <img src="{{asset('upload/tintuc').'/'.$toc->tt_avatar}}" style="margin-top: -15px" alt="ảnh" title="Lập trình Web">
                <h1 class="loai_tin_top_content">{{$toc->tt_name}}</h1>
                <p>{{$toc->title_seo}}</p>
                <h3>{!! $toc->tt_content !!}</p>
                @endforeach
			</div>
