	...
	<div class="container" style="font-size: 16px">
		<nav aria-label="breadcrumb">
		  <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Lớp chinh sửa Video</li>
		  </ol>
		</nav>
		...
		<div class="row">
            <div class="col col-3">
                <ul style="display: block;" class="nav_top_loai_tin">NGÀNH HỌC
                    <li class="nav_loai_tin" style="border-left: 5px solid #fb9d0a; color: #fb9d0a;background: #fff;">Lớp chinh sửa Video</li>
                    ...
                    <li class="nav_loai_tin"><a href="{{route('get.list.lam.toc')}}" class="loai_tin_nav_bar">Lớp làm tóc</a></li>
            ...
            @if(isset($chinhsua))
            <div class="col col-9">
                @foreach($chinhsua as $sua)
                <img src="{{asset('upload/tintuc').'/'.$sua->tt_avatar}}" style="margin-top: -15px" alt="ảnh" title="Lập trình Web">
                <h1 class="loai_tin_top_content">{{$sua->tt_name}}</h1>
                <p style="margin-bottom: 100px">{!! $sua->tt_content !!}</p>
                @endforeach
			</div>
            @endif
		</div>
